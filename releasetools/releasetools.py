...
def FullOTA_InstallEnd(info):
  ...
  info.script.AppendExtra('set_metadata("/system/vendor/bin/netmgrd", "uid", 0, "gid", 2000, "mode", 0755, "capabilities", 0x0, "selabel", "u:object_r:netmgrd_exec:s0");')
  info.script.AppendExtra('set_metadata("/system/vendor/bin/qmuxd", "uid", 0, "gid", 2000, "mode", 0755, "capabilities", 0x0, "selabel", "u:object_r:qmuxd_exec:s0");')
