...
public class HighTouchSensitivity {
    private static final String FILE_MODE = "/sys/devices/i2c-3/3-0020/input/input3/glove_enable";
    ...
    public static boolean isSupported() {
    	boolean x = FileUtils.isFileReadable(FILE_MODE) &&
                FileUtils.isFileWritable(FILE_MODE);
        String z;
        if (x) z="true";
        else z="false";
        Log.d("Is HighTouchSensitivity supported? : "+z,"");
        return x;
    }
    ...
    public static boolean isEnabled() {
        return FileUtils.readOneLine(FILE_MODE).equals("glove touch enable =0x 1");
    }
    ...
    public static boolean setEnabled(boolean status) {
        return FileUtils.writeLine(FILE_MODE, (status ? "glove touch enable =0x 1" : "glove touch enable =0x 0"));
    }
}